...
;(function () {
  ...
  const SITUATIONS = [
    ...
    },
    {
      ...
      answer: 2,
      why: 'A test set drawn from the same narrow distribution as the training set certifies nothing about the factory. This is the single most common way a real project fails, and no amount of extra training or capacity addresses it — you need data that looks like deployment.',
    },
    {
      ...
      answer: 1,
      why: 'The agent is optimising exactly what you wrote. Reward hacking is a specification problem, not a training problem — which is why the Rocket League lesson hands you the weights and invites you to break it deliberately.',
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        'Look at what the layers respond to — feature maps, attention, saliency — and accept the answer will be partial',
  ...
  const CURVES = [
    ...
    },
    {
      ...
      options: ['Overfitting', 'The batches are too large', 'The learning rate is too high — steps overshoot the minimum', 'It has converged'],
      answer: 2,
    ...
    },
    {
      ...
      answer: 1,
      why: 'When training and test loss agree and neither falls, the model is not memorising anything — it is failing to fit even the data in front of it. That is underfitting: too little capacity, a learning rate near zero, or a problem the architecture cannot express, like a spiral through a model with no hidden layer.',
    },
    {
      title: 'Run D',
      draw: (ctx, W, H, plot) => plot(ctx, W, H, [
