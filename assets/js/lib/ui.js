...
;(function (root, factory) {
  ...
  const LESSONS = [
    ...
    {
      id: 'connect4',
      href: 'lessons/connect4.html',
      nav: 'AlphaZero',
      title: 'Teach a model to search',
      blurb: 'A Connect 4 agent that thinks before it moves: hundreds of imagined games per turn, and a network trained on what all that thinking concluded. Play it, then beat it.',
      tags: [['rl', 'search'], ['', 'self-play'], ['', 'AlphaZero']],
      time: '30 min',
    },
    {
      id: 'wordle',
      href: 'lessons/wordle.html',
      nav: 'Information',
      title: 'Guessing with information',
      blurb: 'The best way to play Wordle is not learned from data, it is calculated. Entropy, expected information gain, and a solver you can race.',
      tags: [['core', 'information'], ['', 'entropy'], ['', 'no network']],
      time: '20 min',
    },
    {
      id: 'fighter',
      href: 'lessons/fighter.html',
      nav: 'Game theory',
      title: 'Learning to be unpredictable',
      blurb: 'Fighting-game mixups are rock-paper-scissors with consequences. Regret matching, Nash equilibria, and an agent that reads your habits and punishes them.',
      tags: [['rl', 'game theory'], ['', 'regret matching'], ['', 'imperfect info']],
      time: '25 min',
    },
    {
      id: 'kitchen',
      href: 'lessons/kitchen.html',
      nav: 'Co-op',
      title: 'Cooking with a stranger',
      blurb: 'Two cooks, one score, and nobody to beat. Self-play makes a superb partner for itself and a poor one for anyone else \u2014 measured, not asserted.',
      tags: [['rl', 'multi-agent'], ['', 'cooperation'], ['', 'self-play']],
      time: '25 min',
    },
    {
      id: 'factory',
      href: 'lessons/factory.html',
      nav: 'Optimisation',
      title: 'Optimising without a gradient',
      blurb: 'Build a Factorio production line, then watch a search beat it. Discrete choices, no derivative anywhere, and a landscape that is almost entirely flat.',
      tags: [['core', 'search'], ['', 'annealing'], ['', 'no gradient']],
      time: '25 min',
    },
    {
      id: 'draft',
      href: 'lessons/draft.html',
      nav: 'Draft',
      title: 'Drafting from data',
      blurb: 'A League-style draft where the synergies are real and hidden. Train on match results, then check whether the model rebuilt rules nobody showed it.',
      tags: [['core', 'supervised'], ['', 'tabular'], ['', 'overfitting']],
      time: '20 min',
    },
    {
      id: 'capstone',
      ...
      blurb: 'No sliders, no training, just judgement. Pick the right approach for ten real situations, then diagnose four training runs from the curves alone.',
  ...
  const BADGES = [
    ...
    { id: 'cnn-duel', lesson: 'cnn', label: 'Won a digit duel',
      hint: 'Get 8 digits past the network in the 60-second challenge' },
    { id: 'cnn-duel-gold', lesson: 'cnn', label: 'Gold in the digit duel',
      hint: 'Score 250 points in the digit duel' },
    ...
    { id: 'grid-perfect', lesson: 'gridworld', label: 'Walked the perfect route',
      hint: 'Finish the race in the fewest steps the maze allows' },
    ...
    { id: 'racer-gold', lesson: 'racer', label: 'Gold on a time trial',
      hint: 'Set a gold-medal lap on any of the four courses' },
    ...
    { id: 'rocket-shootout', lesson: 'rocket', label: 'Beat the keeper',
      hint: 'Score at least one of five in the penalty shootout' },
    { id: 'rocket-shootout-perfect', lesson: 'rocket', label: 'Five from five',
      hint: 'Score every shot in the penalty shootout' },
    ...
    { id: 'quiz-language', lesson: 'language', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'c4-beat', lesson: 'connect4', label: 'Beat the search',
      hint: 'Win a game of Connect 4 against a trained checkpoint' },
    { id: 'c4-streak', lesson: 'connect4', label: 'Five in a row',
      hint: 'Win five Connect 4 games in a row without losing' },
    { id: 'c4-trained', lesson: 'connect4', label: 'Self-play works',
      hint: 'Train your own agent to beat the scripted bot 12 times in 20' },
    { id: 'quiz-connect4', lesson: 'connect4', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'wordle-beat', lesson: 'wordle', label: 'Outguessed the solver',
      hint: 'Solve a word in fewer guesses than the information-theory solver' },
    { id: 'wordle-streak', lesson: 'wordle', label: 'Five words ahead',
      hint: 'Beat the solver five games in a row' },
    { id: 'wordle-measured', lesson: 'wordle', label: 'Measured every answer',
      hint: 'Let the page solve all 694 words and report the distribution' },
    { id: 'quiz-wordle', lesson: 'wordle', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'fighter-ahead', lesson: 'fighter', label: 'Read the reader',
      hint: 'Finish a match four points or more ahead' },
    { id: 'fighter-gold', lesson: 'fighter', label: 'Conditioned it',
      hint: 'Get twenty points ahead in a single match' },
    { id: 'fighter-equilibrium', lesson: 'fighter', label: 'Found the equilibrium',
      hint: 'Run self-play until the average mixture is nearly unexploitable' },
    { id: 'quiz-fighter', lesson: 'fighter', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'kitchen-served', lesson: 'kitchen', label: 'Served a soup',
      hint: 'Get at least one soup out of the hatch in a shift' },
    { id: 'kitchen-gold', lesson: 'kitchen', label: 'Ran a good kitchen',
      hint: 'Serve eight soups in a single shift' },
    { id: 'kitchen-collapse', lesson: 'kitchen', label: 'Found the collapse',
      hint: 'Train an agent and measure it dropping off with an unfamiliar partner' },
    { id: 'quiz-kitchen', lesson: 'kitchen', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'factory-built', lesson: 'factory', label: 'Got gears out',
      hint: 'Build a line that delivers at least one gear to the depot' },
    { id: 'factory-beat', lesson: 'factory', label: 'Beat the search',
      hint: 'Hand-build a line with more throughput than the annealer found' },
    { id: 'factory-searched', lesson: 'factory', label: 'Watched it search',
      hint: 'Let the annealer reach 14 gears per hundred ticks' },
    { id: 'factory-sparse', lesson: 'factory', label: 'Saw the flat landscape',
      hint: 'Watch random search fail to find a single working factory' },
    { id: 'quiz-factory', lesson: 'factory', label: 'Passed the quiz',
      hint: 'Answer all three questions correctly' },
    { id: 'draft-played', lesson: 'draft', label: 'Drafted a team',
      hint: 'Finish a draft against the model' },
    { id: 'draft-streak', lesson: 'draft', label: 'Three in a row',
      hint: 'Win three drafts in a row' },
    { id: 'draft-linear', lesson: 'draft', label: 'Beat the linear model',
      hint: 'Win a draft against the one-weight-per-champion model' },
    { id: 'draft-overfit', lesson: 'draft', label: 'Made it overfit',
      hint: 'Train with too little data and watch the held-out loss climb' },
    { id: 'quiz-draft', lesson: 'draft', label: 'Passed the quiz',
      hint: 'Answer the questions at the end of the draft lesson' },
    ...
    { id: 'capstone-approach', lesson: 'capstone', label: 'Picked every approach correctly',
      hint: 'Choose the right method for all ten situations' },
